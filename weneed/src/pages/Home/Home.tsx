  ...
  return (
    <div className={styles.home}>
      ...
      <div className = {styles.header}>
        <div className={styles.container}>
          ...
          <div className={styles.resourceButtons}>
            ...
            >
              <p>공급 가능한 <br /> 자원 등록하기</p>
              <img src={isSupplyHovered ? SupplyIconHover : SupplyIcon} alt="공급 아이콘" />
            </div>
            <div 
            ...
            >
              <p>필요한 자원 <br /> 등록하기</p>
              <img src={isDemandHovered ? DemandIconHover : DemandIcon} alt="수요 아이콘" />
            </div>
    </div>
        </div>
        ...
        <div className={styles.problemCards}>
          <div className = {styles.cardWrapper}>
            ...
            <div className = {styles.cardWrapper}>
              ...
              <div className={styles.problemCard}>
                <p>창업하고 싶은데 정보가<br/> 없어서 필요한 자원을<br/> 구하기가 어려워요.</p>
              </div>
          </div>
          <div className = {styles.cardWrapper}>
            <img src={WorkerImg} alt="" />
            <div className={styles.problemCard}>
              <p>우리 회사에 필요한 <br/>알맞은 양의 자원을 <br/>구하고 싶어요.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={styles.solutionSection}>
        <h3><span className={styles.highlight}>위니드</span>가 제공하는 맞춤 솔루션</h3>
        <div className={styles.solutionCards}>
          <div className={styles.solutionCard}>
            <img src={AibuttonIcon} className ={styles.AiButton} alt="" />
            <div className = {styles.textWrapper}>
              <h4>AI 매칭 기능</h4>
              <p>우리 회사의 집중된 자원 목록을<br/> 바탕으로 AI 매칭 기능이 제공됩니다.</p>
            </div>
          </div>
          <div className={styles.solutionCard}>
            ...
            <div className = {styles.textWrapper}>
              <h4>거래 일지 작성 하기</h4>
              <p>거래를 위한 정보를 쉽게 체계적으로<br/> 기록할 수 있는 거래 일지를 제공합니다.</p>
            </div>
          </div>
          <div className={styles.solutionCard}>
            ...
            <div className = {styles.textWrapper}>
            <h4>지역 부산물 현황 알기</h4>
            <p>with 위니드에서 특정 지역 기업의<br/> 부산물 현황을 파악할 수 있어요.</p>
          </div>
          </div>
        </div>
      </div>
      ...
      <div className={styles.partnershipSection}>
        <img src={MinistryLogo} alt="산업통상자원부 로고" className={styles.partnerLogo} />
        <p>위니드는 서비스의 지속가능성을 위해 대한민국 산업통상자원부와 함께 합니다.</p>
      </div>
